...
const Jewellary = () => {
    ...
    const fetchInventory = async () => {
      try {
        const response = await fetch(
          "https://sgl-be.onrender.com/getloosedimonds"
        );
        if (response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://sgl-be.onrender.com/postloosediamonds",
        {
          method: "POST",
          body: formData,
        }
  ...
  const handleDelete = async (id, index) => {
    try {
      const response = await fetch(
        `https://sgl-be.onrender.com/diamonds/${id}`,
        {
          method: "DELETE",
        }
      );
        ...
        >
          ...
          >
            ...
            >
              ...
              <option value="LooseDiamonds">Loose Diamonds</option>
